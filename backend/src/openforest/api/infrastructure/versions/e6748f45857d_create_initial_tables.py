...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum(
                "admin", "manager", "researcher", "volunteer", "viewer", name="userorganizationrole"
            ),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(["organization_id"], ["organization.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.Column(
            "restoration_status",
            sa.Enum("planned", "active", "completed", "cancelled", name="restorationstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_monitoring_area_visit", "monitoring", ["area_id", "visit_date"], unique=False
    )
    op.create_table(
        "photo",
        sa.Column("id", sa.Uuid(), nullable=False),
