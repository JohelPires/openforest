...
export interface Monitoring {
  ...
  /** Data ISO da visita */
  visit_date: string;
  /** Nome do responsável pela visita (mock-only, ainda sem campo no backend) */
  author: string;
  notes: string;
  seedling_count: number;
  avg_height: number;
  /** Espécies registradas na visita, no formato JSON livre do backend */
...
export interface Area {
  ...
  goal?: string | null;
  /** Data ISO de início do projeto de restauração (mock-only) */
  started_at: string;
  /** Total de mudas plantadas (mock-only) */
  seedlings: number;
  /** Taxa de sobrevivência, em % (mock-only) */
  survival_rate: number;
  /** Visitas aninhadas (mock-only — no backend há endpoint separado) */
    ...
    monitorings: [
      {
        ...
        seedling_count: 980,
        avg_height: 0.4,
        species_data: { Aroeira: {}, "Ipê-amarelo": {}, Angico: {} },
        photos: [
      ...
      },
      {
        ...
        seedling_count: 920,
        avg_height: 1.1,
        species_data: { Aroeira: {}, Embaúba: {}, Cedro: {} },
      ...
      },
      {
        ...
        seedling_count: 870,
        avg_height: 1.9,
        species_data: { Embaúba: {}, Cedro: {}, Jacarandá: {} },
        photos: [
      ...
      },
      {
        ...
        seedling_count: 820,
        avg_height: 2.6,
        species_data: { Aroeira: {}, Cedro: {}, Quaresmeira: {} },
      ...
      },
      {
        ...
        seedling_count: 780,
        avg_height: 4.2,
        species_data: { Aroeira: {}, Cedro: {}, Copaíba: {} },
        photos: [
      ...
      },
      {
        ...
        seedling_count: 760,
        avg_height: 5.1,
        species_data: { Aroeira: {}, Copaíba: {}, Jatobá: {} },
    ...
    monitorings: [
      {
        ...
        seedling_count: 520,
        avg_height: 0.3,
        species_data: { Pequi: {}, Gabiroba: {}, Angico: {} },
  ...
  },
  {
    ...
    monitorings: [
      ...
      },
      {
        ...
        seedling_count: 590,
        avg_height: 3.3,
        species_data: { Ingá: {}, Aroeira: {}, Cedro: {} },
      ...
      },
      {
        ...
        seedling_count: 570,
        avg_height: 4.4,
        species_data: { Ingá: {}, Cedro: {}, Jatobá: {} },
        photos: [
  ...
  },
  {
    ...
    monitorings: [
      ...
      },
      {
        ...
        seedling_count: 620,
        avg_height: 10.1,
        species_data: { Copaíba: {}, Jatobá: {}, "Ipê-roxo": {} },
        photos: [
  ...
  },
  {
    ...
    monitorings: [
      ...
      },
      {
        ...
        seedling_count: 370,
        avg_height: 3.9,
        species_data: { Angico: {}, "Pau-terra": {}, Pequi: {} },
